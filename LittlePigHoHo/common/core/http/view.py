...
from common.core.auth.authModel import HoHoAuthAuthorization
from django.views.generic import View
from ..auth.clientModel import HoHoClientAuthorization

logger = logging.getLogger('django.request')


class HoHoViewBase(View):
    """
    hoho扩展view
    """
    def __init__(self, request, **kwargs):
        super(HoHoViewBase, self).__init__(**kwargs)
